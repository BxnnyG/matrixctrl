...
| 45 | Die Staleness-Warnung war zwölf Tage lang falsch — `addrs[0]` aus einer rotierenden DNS-Antwort; dazu Retention für beide RTC-Tabellen | 🔄 gebaut 2026-08-16 · `v0.1.45` · [plan](plans/etappe-45-address-set.md) |
