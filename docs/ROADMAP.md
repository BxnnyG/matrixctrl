...
| 106 | Zurückspielen, was drin ist — Zähler im Archiv, und ein Tausch statt eines Überschreibens | ✅ 2026-09-25 · `v0.1.94` · [plan](plans/etappe-106-zurueckspielen-was-drin-ist.md) |
| 107–108 | Der Umzug als ein Vorgang · Server-zu-Server ohne Datei | 📋 geplant · [plan](plans/etappe-102-umzug-ohne-shell.md) |
